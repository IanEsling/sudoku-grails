            ...
            <g:each in="${1..9}" var="row" status="rowIndex">
                <tr <g:if test="${rowIndex == 2 || rowIndex == 5}">class="row_divider"</g:if>>
                    <g:each in="${1..9}" var="col" status="cellIndex">
                        ...
                        ">
                            <table id="table${row}${col}" class="select_notes_<g:if test='${light}'>light</g:if><g:else>dark</g:else>">
                                <tr class="note_row">
                                    <g:each in="[1,2,3]" var="cell">
                                        <td class="select_note_cell" onclick="selectForCell(${cell}, '${row}${col}')">${cell}</td>
                                    </g:each>
                                </tr>
                                <tr class="note_row">
